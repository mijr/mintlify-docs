...
|-------------|-----|---------|
| Success | `https://getmipay.com/api/webhooks/success` | POST |
| Failure | `https://getmipay.com/api/webhooks/failure` | POST |
| Generic | `https://getmipay.com/api/webhooks/callback` | POST |
