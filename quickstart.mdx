...
#### Download GetMiPay Merchant App
- **Google Play Store**: [Download here](https://play.google.com/store/apps/details?id=com.GetMiPay.merchant)
- **Apple App Store**: [Download here](https://apps.apple.com/app/GetMiPay-merchant)
- **Web Dashboard**: [getmipay/merchant.com](https://getmipay/merchant.com)
