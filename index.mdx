---
title: "MiPay API Documentation"
description: "Welcome to MiPay - Your universal gateway to Soleaspay"
---

## Get Started

Build powerful payment integrations with MiPay's mobile money API.
...
<Card
  ...
  horizontal
>
  Get up and running with MiPay API in just 5 minutes.
</Card>

## Core Features

Explore MiPay's comprehensive payment solutions.
...
Everything you need to implement MiPay successfully.
...
<Columns cols={2}>
  <Card
    ...
    href="/authentication"
  >
    Learn how to authenticate with API keys and secure your integration.
  </Card>
  <Card
    title="Webhooks"
    icon="bell"
...
<Card
  ...
  icon="headset"
  href="mailto:support@mipay.com"
>
  Our support team is ready to help you succeed with MiPay.
</Card>

<Card
  title="API Status"
  icon="signal"
  href="https://status.mipay.com"
>
